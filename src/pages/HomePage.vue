<template>
  <div class="flex flex-row w-full h-full">
    ...
    <div class="flex flex-col w-1/4 h-full">
      ...
      <UserChats v-else class="" />
    </div>

    <!-- Right side -->
    <div id="BG" class="w-3/4 h-full">
      <CurrentChat v-if="userDataForChat.length" />
      <div v-else class="w-full h-full bg-gray-100 text-center">
